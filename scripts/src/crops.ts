...
export const CropConfigs : { [key in Crops]: Crop } = {
    ...
    [Crops.GoldenCockscomb]: new Crop(Crops.GoldenCockscomb, '金色狗尾草', '', { lo: -5, mid: 0.3, hi: 1 }, 100, 0.01,CropRarity.Legendary, [Crops.Cockscomb, Crops.BigCockscomb], [[10000, 1000], [0, 1e8, 0, 0, 0, 0]], '是一年生草本植物；单生或丛生。秆高可达90厘米，光滑无毛，叶鞘下部扁压具脊，上部圆形，光滑无毛，叶片线状披针形或狭披针形，上面粗糙，下面光滑，圆锥花序紧密呈圆柱状或狭圆锥状，直立，主轴具短细柔毛，刚毛金黄色或稍带褐色，粗糙，第一颖宽卵形或卵形，第二颖宽卵形，第一外稃与小穗等长或微短，第二小花两性，外稃革质，6-10月开花结果。'),
    [Crops.WildSingleWheat]: new Crop(Crops.WildSingleWheat, '野生一粒小麦', '野一小麦', {lo: -1, mid: 0.3, hi: 1}, 1, 1, CropRarity.Uncommon, [Crops.BigCockscomb], [[500], [0, 0, 0, 1e4, 0, 0]], '小麦属中最原始的栽培种。原产小亚细亚。穗小，齐，极紧密，常有芒侧面宽，正面狭。穗轴脆，易折断。每小穗常仅一有芒的花结实，内稃在子粒成熟时纵裂成两片，颖紧密，麦粒不易晚落。晚熟，产量和品质都极差。可用作小麦杂交育种的原始材料。'),
    ...
    [Crops.WildDoubleWheat]: new Crop(Crops.WildDoubleWheat, '野生二粒小麦', '野二小麦', {lo: -1, mid: 0.65, hi: 1}, 1, 6, CropRarity.Rare, [Crops.WildSingleWheat, Crops.Aegilops], [[100, 100], [0, 0, 1e4, 5e4, 0, 0]], '二粒小麦是一粒小麦与山羊草杂交不育后代低温忽然染色体加倍形成的一个异源多倍体植物。'),
    [Crops.DoubleWheat]: new Crop(Crops.DoubleWheat, '二粒小麦', '', { lo: -1, mid: 0.45, hi: 1}, 2, 6, CropRarity.Rare, [Crops.WildDoubleWheat], [[1000], [0, 0, 5e4, 1e4, 0, 0]], '二粒小麦是一粒小麦与山羊草杂交不育后代低温忽然染色体加倍形成的一个异源多倍体植物。'),
    [Crops.Wheat]: new Crop(Crops.Wheat, '小麦', '', { lo: -0.5, mid: 0.7, hi: 1}, 7, 10, CropRarity.Epic, [Crops.DoubleWheat, Crops.Aegilops], [[1000, 1000], [0, 0, 5e4, 1e5, 1e4, 0]], '是禾本科、小麦族下的一属，一年或越年生草本。欧、亚大陆和北美广为栽培。约3000年前，二粒小麦与粗山羊草杂交，由于低温，这个杂交种的染色体忽然加倍，形成了具有42个染色体的异源多倍体，即现在栽培的普通小麦。'),
}
