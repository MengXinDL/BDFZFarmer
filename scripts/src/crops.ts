...
export const CropConfigs : { [key in Crops]: Crop } = {
    ...
    [Crops.WildDoubleWheat]: new Crop(Crops.WildDoubleWheat, '野生二粒小麦', '野二小麦', {lo: -1, mid: 0.65, hi: 1}, 6, 1, CropRarity.Rare, [Crops.WildSingleWheat, Crops.Aegilops], [[100, 100], [0, 0, 1e4, 5e4, 0, 0]], '二粒小麦是一粒小麦与山羊草杂交不育后代低温忽然染色体加倍形成的一个异源多倍体植物。'),
